 ...
 * @stack: a pointer to the top mose node of a stack_t linked list
 ...
 * @stack: a pointer to the top mode node of a stack_t linked list
 * @line_number: the current working line number of a monty bytcodes
 */
void monty_pop(stack_t **stack, unsigned int line_number)
{
	stack_t *next = NULL;
...
/**
 * monty_swap - swaps the top two elemnts of a stack_t linked list
 * @stack: a pointer to the top mode node of a stack_t linked list
 * @line_number: the current workig line number
 */
void monty_swap(stack_t **stack, unsigned int line_number)
{
	stack_t *tmp;
